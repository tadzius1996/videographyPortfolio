...
import graphics from '../public/motionGraphics.jpg';
...
function Works() {
        ...
        <Slider {...settings} className='mt-5'>
          <div className='px-3 group'>
            <div className='relative cursor-pointer'>
              <Image
                src={kiss}
                alt='logo'
                className='w-[30rem] h-auto transition duration-500 ease-in-out group-hover:brightness-50'
              />
          ...
          <div className='px-3 group cursor-pointer'>
            <div className='relative'>
              ...
              />
              <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full bg-opacity-50 py-2 px-3 text-white transition duration-500 ease-in-out opacity-0 group-hover:opacity-100'>
              <a href='https://www.youtube.com/watch?v=iqZt6V1totg&t=1s&ab_channel=HFiles' className='text-xl tracking-widest'>MOTION GRAPHICS</a>
              </div>
            </div>
          </div>
          <div className='px-3 group cursor-pointer'>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className='mt-[2rem]'><path fill="#c2613d" fill-opacity="1" d="M0,192L30,181.3C60,171,120,149,180,128C240,107,300,85,360,90.7C420,96,480,128,540,165.3C600,203,660,245,720,224C780,203,840,117,900,122.7C960,128,1020,224,1080,266.7C1140,309,1200,299,1260,261.3C1320,224,1380,160,1410,128L1440,96L1440,320L1410,320C1380,320,1320,320,1260,320C1200,320,1140,320,1080,320C1020,320,960,320,900,320C840,320,780,320,720,320C660,320,600,320,540,320C480,320,420,320,360,320C300,320,240,320,180,320C120,320,60,320,30,320L0,320Z"></path></svg>
</div>
);
}
